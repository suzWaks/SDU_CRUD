                        ...
                        <div className="relative bg-white rounded-lg shadow dark:bg-gray-700 p-1">
                            ...
                            <form onSubmit={handleAddDepartment} className="p-4 md:p-5">
                                <div className="grid gap-4 mb-4 grid-cols-2">
                                    ...
                                    <div className="col-span-2">
                                        <label htmlFor="description" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Department Description</label>
                                        <textarea
                                            id="description"
                                            maxLength="256"
                                            rows="4"
                                ...
                                <button type="submit" className="text-white inline-flex items-center bg-sky-600 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
