                    ...
                    >
                        ...
                        <div className="p-5 flex flex-col justify-between">
                            <div className="flex items-center justify-between mb-2">
                                ...
                                <h5 onClick={() => viewDeptHandler(card.deptId, navigate)} className="text-2xl font-bold tracking-tight
                            ...
                            <p onClick={() => viewDeptHandler(card.deptId, navigate)} className="cursor-pointer mb-3 font-normal
                    ...
                    <div class="relative p-4  max-h-full">
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <div class="flex flex-col items-center justify-center p-4 md:p-5 text-center">
                                ...
                                <button onClick={closeModal} class="text-white bg-sky-600 hover:bg-sky-700 focus:ring-4 
